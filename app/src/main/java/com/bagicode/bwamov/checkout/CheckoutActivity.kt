...
import com.bagicode.bwamov.home.TiketActivity
...
class CheckoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (preferences.getValues("saldo")!!.isNotEmpty()){
            ...
            textView40.visibility = View.INVISIBLE
        }else {
            tv_saldo.setText("Rp 0")
            btn_tiket.visibility = View.INVISIBLE
            textView40.visibility = View.VISIBLE
            textView40.text = " Saldo pada e-wallet kamu tidak mencukupi\n"+
